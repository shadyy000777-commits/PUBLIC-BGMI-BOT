...
const { startPending, getPending, updatePending, clearPending } = require('./t3-pending-registrations');
const { buildStep1Modal, buildStep2Modal, buildStep3Modal } = require('./t3-registration-modals');
const {
