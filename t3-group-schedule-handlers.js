...
const { getScheduleForPosition, setSchedule, getGroupsPerDay } = require('./t3-group-schedule');
...
function buildGroupSchedulePanelPayload(store) {
  ...
  const select = new StringSelectMenuBuilder()
    .setCustomId('t3_group_schedule_select')
...
function buildScheduleModal(position, store) {
  ...
  return new ModalBuilder()
    .setCustomId(`t3_group_schedule_modal:${position}`)
